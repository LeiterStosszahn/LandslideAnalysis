...
class creatFishnet:
    ...
    def execute(self, parameters, messages):
        ...
        for day in days:
            ...
            ## Creat Thiessen
            pathThiessen = os.path.join("Thiessen" + memoryName) # Thiessen do not support memory process
            ...
            arcpy.management.Delete(pathThiessen)
            ...
            ## Creat Thiessen
            pathThiessen = os.path.join("ThiessenB" + memoryName) # Thiessen do not support memory process
        ...
        arcpy.management.SelectLayerByAttribute(savePath, "NEW_SELECTION", expression)
        arcpy.management.CalculateField(savePath, "landslide", '0', "PYTHON3")
        arcpy.management.SelectLayerByAttribute(savePath, "CLEAR_SELECTION")
